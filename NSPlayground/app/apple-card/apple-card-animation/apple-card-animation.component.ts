...
@Component({
  ...
  templateUrl: './apple-card/apple-card-animation/apple-card-animation.component.html',
  styleUrls: ['./apple-card/apple-card-animation/apple-card-animation.component.scss']
})
